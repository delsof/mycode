#!/usr/bin/python3
"""Learning about Python SSH | delsof@gmail.com"""
# CUSTOMIZATION REQUEST 02 - Read from a JSON file and written out to a file sshscript.log
#      A single entry goes into the file everytime it is executed.
...
def main():
    ...
    with open("credzAPIC.json", "r") as f:
        credz = json.load(f)
    ...
    print(output)
    with open("sshscript.log", "a") as f:
       	f.write(output + "\n")
    ...
    print("Thanks for looping with Surintek!")
    print("See sshscrip.log file for output")
